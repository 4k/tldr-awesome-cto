...
**Source:** https://about.gitlab.com/handbook/finance/financial-planning-and-analysis/
...
Our objectives
- Facilitate aligned cross-functional execution of GitLab’s strategy
...
- Manage the budget and planning processes for GitLab’s Board Plan
- Build and maintain a long-term financial model that identifies long-term strategy and financial targets
- Define business drivers and KPIs in our operating and long-term models in collaboration with the business and measure efficacy of the business plan
...
- Analytics Issue Tracker for all data, dashboard, or reporting requests
- FP&A Job Ladder
- Adaptive Insights
Key Slack Channels
FP&A Processes
...
- Governance: The Forecast at
FYyyyy-mm
is approved by the Head of FP&A and reviewed with the CFO. - Note: Prior to locking and archiving any version in Adaptive, Corporate FP&A will update the FX rates in Adaptive using Google Finance FX Rates.
Forecast at FYyy-Qx
...
-
Throughout quarter, FP&A maintains alignment with business needs.
...
-
During quarterly RLOA process, FP&A team finalizes RLOA proposal to share with e-group, and communicates decisions to functional leaders to enable business execution. Below is the timeline
