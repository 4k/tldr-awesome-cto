...
repo at a technical level). We will refer to this repo as origin
, since this
...
a severe bug. But changes on develop
...
result in the bugfix being merged into develop
too, when the release branch
is finished. (If work in develop
